 ...
 * 第一个模块：加减乘除
 */
var $app1 = (0, _jquery2.default)('#app1');
var $span = $app1.children('span');
var $btns = $app1.children('button');

var number = Number(localStorage.getItem('number')) || 100;
$span.text(number);
 ...
 * 第二个模块：tab 切换
 */
var $app2 = (0, _jquery2.default)('#app2');
var $tabBar = $app2.find('.tab-bar > li');
var $tabContent = $app2.find('.tab-content > li');

(0, _jquery2.default)($tabContent.eq(0)).css('display', 'block');
...
(0, _jquery2.default)('.circle').on('mouseenter', function () {
...
require('./app4');
},{"./reset.css":"reset.css","./app1":"app1.js","./app2":"app2.js","./app3":"app3.js","./app4":"app4.js"}],"C:\\Users\\Administrator\\AppData\\Roaming\\npm\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '6665' + '/');
...
//# sourceMappingURL=/main.b107a9dc.map